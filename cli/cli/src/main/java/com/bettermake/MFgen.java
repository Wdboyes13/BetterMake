...
public class MFgen {
    public static void main(String[] args, String prjName, String lang) throws IOException {
        Files.createDirectory(Paths.get(prjName+"/src"));
        Files.createDirectory(Paths.get(prjName+"/build"));
        Files.createDirectory(Paths.get(prjName+"/rls"));
        // Create build dirs
        {
            Files.createDirectory(Paths.get(prjName+"/build/LIN64"));
            Files.createDirectory(Paths.get(prjName+"/build/LINARM"));
            Files.createDirectory(Paths.get(prjName+"/build/MAC64"));
            Files.createDirectory(Paths.get(prjName+"/build/MACARM"));
            Files.createDirectory(Paths.get(prjName+"/build/WIN64"));
            Files.createDirectory(Paths.get(prjName+"/build/WINARM"));
        }
        // Create rls dirs
        {
